...
<header class="site-header">
    <div class="container header-wrap">
        ...
        <nav class="menu" id="headerMenu">
            ...
            <a href="<?= route_url('/index.php#product-list') ?>">Xem Sản Phẩm</a>
            <a href="<?= route_url('/cart.php') ?>">Giỏ hàng (<?= (int)get_cart_item_count() ?>)</a>
            ...
            <?php else: ?>
                ...
                <a href="<?= route_url('/customer/register.php') ?>">Đăng ký</a>
            <?php endif; ?>
            <a target="_blank" rel="noopener noreferrer" href="<?= e($shopZaloLink) ?>">Liên hệ</a>
        </nav>
    </div>
</header>
