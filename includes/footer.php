...
<?php $shopName = function_exists('shop_name') ? shop_name() : 'Duong Mot Mi SHOP'; $shopTagline = function_exists('shop_tagline') ? shop_tagline() : 'Khám phá phong cách thời trang trẻ trung, hiện đại.'; $shopZaloLink = function_exists('shop_zalo_link') ? shop_zalo_link() : (defined('ZALO_LINK') ? ZALO_LINK : '#'); $shopPhone = function_exists('shop_setting') ? shop_setting('shop_phone', '') : ''; $shopHours = function_exists('shop_setting') ? shop_setting('shop_working_hours', '') : ''; $shopAddress = function_exists('shop_setting') ? shop_setting('shop_address', '') : ''; $shopFacebookLink = function_exists('shop_social_link') ? shop_social_link('facebook') : '#'; $shopInstagramLink = function_exists('shop_social_link') ? shop_social_link('instagram') : '#'; ?>
<footer class="site-footer">
    <div class="container">
        <div class="footer-top">
            ...
            <div class="footer-col">
                ...
                <div class="footer-socials">
                    <a href="<?= e($shopFacebookLink ?: "#") ?>" target="_blank" title="Facebook">
                    ...
                    <a href="<?= e($shopInstagramLink ?: "#") ?>" target="_blank" title="Instagram">
                    ...
                    <a href="<?= e($shopZaloLink) ?>" target="_blank" title="Zalo">
            ...
            <div class="footer-col">
                ...
                <ul style="color: var(--text-muted); font-size: 15px;">
                    <li style="margin-bottom: 14px;"><strong style="color: var(--text-main);">Hotline/Zalo:</strong> <?= e($shopPhone) ?></li>
                    <li style="margin-bottom: 14px;"><strong style="color: var(--text-main);">Giờ làm việc:</strong> <?= e($shopHours) ?></li>
                    <li><strong style="color: var(--text-main);">Địa chỉ:</strong> <?= e($shopAddress) ?></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom">
            <p>&copy; <?= date('Y') ?> <?= e($shopName) ?>. Tự hào thiết kế và vận hành.</p>
        </div>
    </div>
</footer>
